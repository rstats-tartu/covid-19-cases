...
>>>>>>> 2587ace2e597cf9206e82223a70c9422ac5f635c
```
...
=======
ggplot(covid %>% filter(daterep> "2020-03-01"), aes(daterep, cases, fill=geoid))+
  geom_col()+
  theme(legend.position = "none")+
>>>>>>> 2587ace2e597cf9206e82223a70c9422ac5f635c
  xlab(NULL)
...
#  theme(legend.position = "none")+
=======
ggplot(covid %>% filter(daterep> "2020-03-01"), aes(daterep, deaths, fill=geoid))+
  geom_col()+
  theme(legend.position = "none")+
>>>>>>> 2587ace2e597cf9206e82223a70c9422ac5f635c
  xlab(NULL)
...
ggplot(cov1 %>% filter(daterep> "2020-03-18"), aes(daterep, risk_7, color=country))+
  ...
  scale_color_jcolors(palette = "rainbow")+
  geom_dl(aes(label = geoid), method = list(dl.combine("last.points"), cex = 0.8)) +
  labs(caption = "risk_7 = cumulative deaths / cumulative cases_lag_7") +
  theme(legend.position = "none")
```
